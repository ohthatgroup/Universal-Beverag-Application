...
const PRODUCT_FIELDS: BulkFieldDefinition[] = [
  ...
  },
  {
    ...
    description: 'Primary nav family: soda | water | sports_hydration | tea_juice | energy_coffee | other.',
    requiredOnImport: false,
    sample: 'soda',
    aliases: ['productFamily', 'family'],
  },
  {
    key: 'browse_model',
    label: 'Browse model',
    description: 'Family-specific secondary nav: format-led | water-type-led | subline-then-size | brand-led | price-point-led.',
    requiredOnImport: false,
    sample: 'brand-led',
    aliases: ['browseModel'],
  },
  {
    key: 'subline',
    label: 'Subline',
    description: 'Sub-line within a brand (e.g. Gatorade Zero, Coke Zero).',
    requiredOnImport: false,
    sample: null,
    aliases: ['sub_line', 'subLine'],
  },
  {
    key: 'pack_key',
    label: 'Pack key',
    description: 'Canonical normalized pack notation (e.g. 24x12oz_can).',
    requiredOnImport: false,
    sample: null,
    aliases: ['packKey'],
  },
  {
    key: 'water_type',
    label: 'Water type',
    description: 'still | sparkling | enhanced | coconut.',
    requiredOnImport: false,
    sample: null,
    aliases: ['waterType'],
  },
  {
    key: 'price_point',
    label: 'Price point',
    description: 'Resale price-point program (e.g. 99c, 1.25).',
    requiredOnImport: false,
    sample: null,
    aliases: ['pricePoint'],
  },
  {
    key: 'is_zero_sugar',
    label: 'Zero sugar',
    description: 'Marks the product as zero sugar.',
    requiredOnImport: false,
    sample: false,
    aliases: ['isZeroSugar', 'zeroSugar', 'zero_sugar'],
  },
  {
    key: 'is_diet',
    label: 'Diet',
    description: 'Marks the product as diet.',
    requiredOnImport: false,
    sample: false,
    aliases: ['isDiet', 'diet'],
  },
  {
    key: 'is_caffeine_free',
    label: 'Caffeine free',
    description: 'Marks the product as caffeine free.',
    requiredOnImport: false,
    sample: false,
    aliases: ['isCaffeineFree', 'caffeineFree', 'caffeine_free'],
  },
  {
    key: 'is_sparkling',
    label: 'Sparkling',
    description: 'Marks the product as sparkling.',
    requiredOnImport: false,
    sample: false,
    aliases: ['isSparkling', 'sparkling'],
  },
  {
    key: 'search_aliases',
    label: 'Search aliases',
    description: 'Comma-separated rescue search vocabulary (brand misspellings, pack-notation variants).',
    requiredOnImport: false,
    sample: null,
