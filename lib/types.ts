...
export interface Database {
  public: {
    Tables: {
      ...
      customer_products: {
        Row: CustomerProduct
        Insert: CustomerProductInsert
        Update: CustomerProductUpdate
      }
      pallet_deals: {
        Row: PalletDeal
        Insert: PalletDealInsert
        Update: PalletDealUpdate
      }
      pallet_deal_items: {
        Row: PalletDealItem
        Insert: PalletDealItemInsert
        Update: PalletDealItemUpdate
      }
      orders: {
        Row: Order
        Insert: OrderInsert
      ...
      order_cutoffs: {
        Row: OrderCutoff
        Insert: OrderCutoffInsert
        Update: OrderCutoffUpdate
      }
      product_cutoff_overrides: {
        Row: ProductCutoffOverride
        Insert: ProductCutoffOverrideInsert
        Update: ProductCutoffOverrideUpdate
      }
    }
    Functions: {
      is_salesman: {
